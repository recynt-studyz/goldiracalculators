...
const tools = [
  { href: '/', label: 'IRA Growth' },
  { href: '/rollover', label: '401k Rollover' },
  { href: '/gold-vs-stocks', label: 'Gold vs Stocks' },
  { href: '/fee-calculator', label: 'Fee Impact' },
...
export default function CalcNav() {
  ...
  const toggleDark = () => {
    ...
    try {
      localStorage.setItem('gic-theme', next ? 'dark' : 'light')
    } catch {
      // ignore
    }
  }
  ...
  return (
    <nav aria-label="Gold IRA calculator navigation" className="px-4 sm:px-6 overflow-x-auto">
